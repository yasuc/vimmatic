export const defaultJSONSettings = `{
  "keymaps": {
    ...
    "<A-h>": { "type": "scroll.horizonally", "count": -1 },
    "<A-l>": { "type": "scroll.horizonally", "count": 1 },
    ...
    "h": { "type": "tabs.prev" },
    "l": { "type": "tabs.next" },
    "<C-p>": { "type": "tabs.move.prev" },
    "<C-n>": { "type": "tabs.move.next" },
    "<A-p>": { "type": "tabs.move.prev" },
    "<A-n>": { "type": "tabs.move.next" },
    "gT": { "type": "tabs.prev" },
    "gt": { "type": "tabs.next" },
    "g0": { "type": "tabs.first" },
    "g$": { "type": "tabs.last" },
    ...
    "u": { "type": "tabs.reload", "cache": false },
