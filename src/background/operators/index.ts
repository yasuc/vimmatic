...
import { MoveTabNextOperator } from "./impls/MoveTabNextOperator";
import { MoveTabPrevOperator } from "./impls/MoveTabPrevOperator";
...
import { YankTitleOperator } from "./impls/YankTitleOperator";
...
export class OperatorRegistryFactory {
  constructor(
    ...
    @inject(MoveTabNextOperator)
    private readonly moveTabNextOperator: MoveTabNextOperator,
    @inject(MoveTabPrevOperator)
    private readonly moveTabPrevOperator: MoveTabPrevOperator,
    ...
    @inject(YankTitleOperator)
    private readonly yankTitleOperator: YankTitleOperator,
  ...
  create(): OperatorRegistry {
    ...
    r.register(this.moveTabNextOperator);
    r.register(this.moveTabPrevOperator);
    ...
    r.register(this.yankTitleOperator);
